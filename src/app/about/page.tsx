...
const ABOUT_CONTENT = {
  ...
  mn: {
    ...
    motto: "“Өөрөөсөө давсан үйлчлэл.”",

    areasTitle: "Үйл ажиллагааны чиглэл",
    areas: ["Өвчнөөс урьдчилан сэргийлэх, эмчилгээ", "Боловсролыг дэмжих"],

    characteristicsTitle: "Клубын онцлог",
    characteristics: ["Гурван үеийг төлөөлсөн гишүүд"],
    ...
    sidebarLinks: [
      ...
      { href: "/timeline", label: "• Түүхэн замнал" },
    ...
    <div className="bg-white max-w-[1400px] mx-auto rounded-3xl shadow-lg overflow-hidden">
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-4 md:py-16 grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <aside className="hidden lg:block">
          <div className="bg-[#f6f7f9] rounded-xl p-6 shadow-lg sticky top-24">
            ...
            <ul className="space-y-3 text-[#17458f]">
              {t.sidebarLinks.map((link, i) => (
                <li key={i}>
                  <Link href={link.href} className="hover:text-[#ffd2c2]">
                    {link.label}
                  </Link>
                </li>
              ))}
